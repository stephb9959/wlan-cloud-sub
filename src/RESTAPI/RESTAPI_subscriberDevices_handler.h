...
#ifndef OWSUB_RESTAPI_SUBSCRIBERDEVICES_HANDLER_H
#define OWSUB_RESTAPI_SUBSCRIBERDEVICES_HANDLER_H

#include "framework/MicroService.h"

namespace OpenWifi {
    class RESTAPI_subscriberDevices_handler : public RESTAPIHandler {
    public:
        RESTAPI_subscriberDevices_handler(const RESTAPIHandler::BindingMap &bindings, Poco::Logger &L, RESTAPI_GenericServer & Server, bool Internal)
